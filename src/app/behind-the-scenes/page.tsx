...
export const metadata: Metadata = {
  title: 'Behind the Scenes & Our Story – Why We Built GitLegacy',
  description:
  ...
  openGraph: {
    title: 'Behind the Scenes: Why We Built GitLegacy',
    description:
    ...
    url: 'https://gitlegacy.co/behind-the-scenes',
    type: 'article',
    siteName: 'GitLegacy',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://gitlegacy.co/behind-the-scenes',
  },
};
